...
export const storyQuests: StoryQuest[] = [
  ...
  {
    // 그룹=컨테이너 게이트 시연: 진행중 그룹(groupId 1) 안의 미게시(임시저장) 에피소드 — 독립 상태
    id: 5, groupId: 1, episodeKind: 'MAIN', displayOrder: 5,
    artistGroup: 'V01D', status: 'DRAFT',
    titleKO: '시즌 피날레 — 팬미팅 인증 (미게시)',
    titleEN: 'Season Finale — Fan Meeting Proof (Draft)',
    titleJA: 'シーズンフィナーレ — ファンミーティング認証 (下書き)',
    imageUrl: '/sq/v01d-journey-05.jpg',
    descKO: 'JOURNEY #01 시즌 피날레 — 팬미팅 참여 인증 + 시즌 회고. (그룹은 진행중이나 본 에피소드는 아직 미게시)',
    descEN: 'JOURNEY #01 season finale — fan meeting proof + season retrospective. (Group active, this episode not yet published)',
    descJA: 'JOURNEY #01 シーズンフィナーレ — ファンミーティング参加認証 + シーズン回顧。(グループは進行中だが本エピソードは未公開)',
    episodeCount: 1,
...
export const storyEpisodes: StoryEpisode[] = [
  ...
  { id: 102, storyQuestId: 1, order: 2, type: 'PREDICTION_MARKET',
    ...
    rewardEntryTicket: 0, rewardFanPoint: 200, biveRewardYn: false, mintingEventId: null, mintingEventName: null,
  ...
  { id: 103, storyQuestId: 1, order: 3, type: 'SURVIVAL_TRIVIA',
    ...
    rewardEntryTicket: 0, rewardFanPoint: 150, biveRewardYn: false, mintingEventId: null, mintingEventName: null,
  ...
  { id: 302, storyQuestId: 3, order: 2, type: 'SURVIVAL_TRIVIA',
    ...
    rewardEntryTicket: 0, rewardFanPoint: 180, biveRewardYn: false, mintingEventId: null, mintingEventName: null,
  ...
  { id: 602, storyQuestId: 6, order: 2, type: 'SURVIVAL_TRIVIA',
    ...
    rewardEntryTicket: 0, rewardFanPoint: 50, biveRewardYn: false, mintingEventId: null, mintingEventName: null,
  ...
  { id: 801, storyQuestId: 8, order: 1, type: 'SURVIVAL_TRIVIA',
    ...
    rewardEntryTicket: 0, rewardFanPoint: 250, biveRewardYn: false, mintingEventId: null, mintingEventName: null,
    repeat: false, inProgressMembers: 2510, completedMembers: 2380,
  ...
  { id: 2301, storyQuestId: 23, order: 1, type: 'PREDICTION_MARKET',
    ...
    rewardEntryTicket: 0, rewardFanPoint: 100, biveRewardYn: false, mintingEventId: null, mintingEventName: null,
    repeat: false, inProgressMembers: 0, completedMembers: 0,
