...
export const TEMPLATES: NotiTemplate[] = [
  {
    id: 'TMPL-001',
    name: '공지 — 약관 개정',
    channel: 'BASIC_PUSH',
    title: { ko: '약관 개정 사전 안내', en: 'Terms Update Notice', jp: '約款改定のお知らせ' },
    body: {
      ko: '서비스 이용약관이 개정됩니다. 자세한 내용은 공지사항에서 확인해 주세요.',
      en: 'Terms will be updated. See the notice for details.',
      jp: 'サービス利用約款が改定されます。',
    },
    deeplinkSourceType: 'INF_NEWS',
    deeplinkLabel: '소식 — 약관 개정 공지',
    updatedAt: '2026.04.20 10:00',
    updatedBy: 'nill',
    lastUsedAt: '2026.05.18 21:55',
  },
  {
    id: 'TMPL-002',
    name: '재사용 — 컴백 안내',
    channel: 'BASIC_PUSH',
    title: { ko: '[아티스트] 컴백 안내', en: '[Artist] Comeback', jp: '[アーティスト] カムバック' },
    body: { ko: '새 미니앨범 발매를 알려드립니다. 응모하기에서 한정판 굿즈를 만나보세요.', en: 'New mini album. Join the raffle for limited goods.', jp: '新ミニアルバム発売。応募で限定グッズをゲット。' },
    deeplinkSourceType: 'ARTIST_HOME',
    deeplinkLabel: '아티스트 홈',
    updatedAt: '2026.05.10 11:00',
    updatedBy: 'nill',
    lastUsedAt: '2026.05.18 14:25',
  },
  {
    id: 'TMPL-003',
    name: '재사용 — BIVE 컬렉션 민팅 D-1',
    channel: 'BASIC_PUSH',
    title: { ko: '[BIVE] [컬렉션명] 민팅 D-1', en: '[BIVE] Minting D-1', jp: '[BIVE] ミンティングD-1' },
    body: {
      ko: '내일 [HH:mm], [컬렉션명] 민팅이 시작됩니다. 보유 응원권으로 우선 민팅 기회를 놓치지 마세요.',
      en: 'Minting starts tomorrow at [HH:mm]. Use your cheer tickets for priority access.',
      jp: '明日[HH:mm]、ミンティング開始。',
    },
    pushShort: { ko: '민팅 D-1 ⏰', en: 'Minting D-1 ⏰', jp: 'ミンティング D-1 ⏰' },
    deeplinkSourceType: 'BIVE_CAMPAIGN',
    deeplinkLabel: 'BIVE 컬렉션 상세',
    updatedAt: '2026.05.14 10:00',
    updatedBy: 'nill',
    lastUsedAt: '2026.05.18 20:00',
  },
  {
    id: 'TMPL-004',
    name: '재사용 — 응모권 만료 임박 캠페인',
    channel: 'BASIC_PUSH',
    title: { ko: '[응모권 만료 임박] [기간] 안내', en: '[Tickets Expiring] [Period]', jp: '[応募券期限] [期間]' },
    body: {
      ko: '[YYYY.MM.DD]까지 만료 예정인 응모권이 있으신지 확인해 보세요. 마지막 응모 기회를 놓치지 마세요!',
      en: 'Check if you have tickets expiring by [YYYY.MM.DD].',
      jp: '[YYYY.MM.DD]までに期限切れの応募券をご確認ください。',
    },
    deeplinkSourceType: 'PROMO',
    deeplinkLabel: '응모권 보관함',
    updatedAt: '2026.05.05 10:00',
    updatedBy: 'nill',
    lastUsedAt: '2026.05.19 11:30',
  },
];

export function getTemplateById(id: string): NotiTemplate | undefined {
