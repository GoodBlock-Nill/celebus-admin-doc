...
export interface FeedItem {
  ...
  title: ML; // 제목 / 일정명
  // 소식·공지=게시일(최초 [게시] 시점 자동 기록, 재게시해도 불변·임시저장은 빈 값) / 일정=이벤트 일자 (YYYY.MM.DD)
  date: string;
  likes?: number;
  // 일정
  time?: string; // HH:mm
...
export const feedItems: FeedItem[] = [
  // 일정 (장소 / 부제·썸네일 없음)
  { id: 1, type: '일정', status: '게시', groupName: 'V01D', official: true, title: ml('MBC 음악중심 출연', 'MBC Music Core Appearance', 'MBC 音楽中心 出演'), date: '2026.05.18', time: '12:00', location: '잠실 MBC 방송센터' },
  { id: 2, type: '일정', status: '게시', groupName: 'V01D', official: true, title: ml('뮤직뱅크 출연', 'Music Bank Appearance', 'ミュージックバンク 出演'), date: '2026.05.20', time: '12:00', location: 'KBS 본관' },
  { id: 3, type: '일정', status: '게시', groupName: 'V01D', official: true, title: ml('런닝맨 출연', 'Running Man Appearance', 'ランニングマン 出演'), date: '2026.08.18', time: '12:00', location: 'SBS 목동 방송센터' },
  { id: 4, type: '일정', status: '게시', groupName: 'V01D', official: false, title: ml('V01D 팬미팅', 'V01D Fan Meeting', 'V01D ファンミーティング'), date: '2026.04.30', time: '14:00', location: '여의도 IFC몰' },
  { id: 5, type: '일정', status: '임시저장', groupName: 'iKON', official: true, title: ml('iKON 콘서트 추가 공연', '', ''), date: '2026.06.15', time: '18:00', location: '고척 스카이돔' },

  // 소식 (다국어 본문 + 이미지 배열 + 연관 콘텐츠)
  { id: 6, type: '소식', status: '게시', groupName: 'V01D', official: true, title: ml('V01D 신곡 "Tug of War" 뮤직비디오 공개', 'V01D Drops "Tug of War" Music Video', 'V01D 新曲「Tug of War」MV公開'), date: '2026.05.18', body: TUG_BODY, images: ['tugofwar-mv-1.jpg', 'tugofwar-mv-2.jpg', 'tugofwar-bts.jpg'], likes: 2000, relatedContents: [
  ...
  { id: 7, type: '소식', status: '게시', groupName: 'V01D', official: true, title: ml('V01D 일본 데뷔 확정', 'V01D Confirms Japan Debut', 'V01D 日本デビュー決定'), date: '2026.04.30', body: ml('V01D의 일본 데뷔가 확정되었습니다. 자세한 일정은 추후 공개됩니다.', 'V01D\'s Japan debut is confirmed. Details will be announced soon.', 'V01Dの日本デビューが決定しました。詳細は後日公開されます。'), images: ['japan-debut.jpg'], likes: 1340, relatedContents: [] },
  { id: 8, type: '소식', status: '게시', groupName: 'V01D', official: false, title: ml('V01D 새 앨범 프리뷰 공개', 'V01D New Album Preview', 'V01D 新アルバム プレビュー公開'), date: '2026.05.18', body: ml('새 앨범의 프리뷰 영상이 공개되었습니다.', 'A preview video for the new album has been released.', '新アルバムのプレビュー映像が公開されました。'), images: [], likes: 720, relatedContents: [
  ...
  // 소식 임시저장
  { id: 13, type: '소식', status: '임시저장', groupName: 'V01D', official: false, title: ml('V01D 컴백 D-7 스페셜 영상 공개 예정', 'V01D Comeback D-7 Special Video Coming Soon', 'V01D カムバックD-7 スペシャル映像 公開予定'), date: '', body: ml('컴백을 일주일 앞두고 스페셜 영상이 공개될 예정입니다. (작성 중)', 'A special video will be released one week ahead of the comeback. (Draft)', 'カムバックを一週間後に控え、スペシャル映像が公開される予定です。(作成中)'), images: ['comeback-teaser.jpg'], likes: 0, relatedContents: [] },
