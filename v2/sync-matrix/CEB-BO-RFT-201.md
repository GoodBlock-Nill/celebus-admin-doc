...
| 2 | §2-1 | 출처 드롭다운 — 정규 5종 + 사용 1종 (운영 카테고리 폐기) | sourcePolicies 6종 | ✅ (2026-05-21 정정 — v2.6에서 운영 카테고리 3종 폐기) |
...
| 7 | (폐기) | ~~운영 카테고리 행 출처 컬럼 "(운영) {유형}" 표기~~ | 분기 제거됨 | 🚫 폐기 (2026-05-21 정정 — v2.6 운영 카테고리 자체 폐기) |
...
| # | 항목 | 위치 | 상태 |
|---|---|---|---|
| M1 | RftSourceFeature 6종 (정규 발급 5종 + 사용 1종) | mock/rft.ts:7~14 | ✅ (2026-05-21 정정 — 운영 카테고리 3종 폐기) |
| M2 | sourcePolicies 6종 SourceMeta 배열 | mock/rft.ts:53~131 | ✅ (2026-05-21 정정) |
| M3 | RftLog.memberDeleted 옵션 필드 | mock/rft.ts:51 | ✅ (2026-05-21 정정) |
| M4 | refMap·refIdMap 6종 매핑 | mock/rft.ts:252~268 | ✅ (2026-05-21 정정) |
...
| 2026-05-21 | **운영 카테고리 3종 정책 자체 폐기 정합 (사용자 결정)** — [CEB-BO-010] v2.6 §4-3 운영 카테고리 자체 폐기에 따라 mock·드롭다운·출처 컬럼 "(운영)" 분기 일괄 제거. 정규 발급 5종 + 사용 1종 = 6종으로 단순화. 직전 추가분 전체 환원. 삭제 회원·"전역" 라벨 정정은 그대로 유지 |
